...
class FinanceDamageView extends StatefulWidget {
  FinanceDamageView({Key key, this.propertyid, this.apid});

  String propertyid;
  String apid;

  @override
  FinanceDamageViewState createState() => FinanceDamageViewState();
}

class FinanceDamageViewState extends State<FinanceDamageView> {
  bool loading = false;
