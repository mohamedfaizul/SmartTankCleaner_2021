...
import 'package:tankcare/FINANCE%20TEAM/FinanceDamageView.dart';
...
class FinanceApprovalList extends StatefulWidget {
  @override
  FinanceApprovalListState createState() => FinanceApprovalListState();
}

class FinanceApprovalListState extends State<FinanceApprovalList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    if (dropdownValue == '-- Approval Status --' &&
      ...
      url = String_values.base_url +
        ...
        dropdownValue2 == 'Bill')
      url = String_values.base_url +
          'approval-functions-list?page=${page}&limit=10&ap_type=planbill';
    else if (dropdownValue == '-- Approval Status --' &&
    ...
    else if (dropdownValue == 'Pending' && dropdownValue2 == 'Bill')
      url = String_values.base_url +
          'approval-functions-list?page=${page}&limit=10&ap_type=planbill&ap_status=P';
    ...
    else if (dropdownValue == 'Approved' && dropdownValue2 == 'Bill')
      url = String_values.base_url +
          'approval-functions-list?page=${page}&limit=10&ap_type=planbill&ap_status=A';
    ...
    else if (dropdownValue == 'Rejected' && dropdownValue2 == 'Bill')
      url = String_values.base_url +
          'approval-functions-list?page=${page}&limit=10&ap_type=planbill&ap_status=R';
                                                    ...
                                                    if (value) {
                                                      if (list.apProcessName ==
                                                        ...
                                                        Navigator.pushReplacement(
                                                            context,
                                                            MaterialPageRoute(
                                                                builder: (context) => FinanceDamageView(
                                                                    propertyid: list
                                                                        .apTblId,
                                                                    apid: list
                                                                        .apId)));
  ...
  static Future<List> getSuggestions(String query) async {
    var url = //'http://35.184.156.126.xip.io/cyberhome/home.php?username=kavin&query=table';
        String_values.base_url +
            ...
            FinanceApprovalListState.roleid;
