...
import 'package:tankcare/DISTRICT%20VENDOR/ApprovalList.dart';
import 'package:tankcare/Vendor/Login/Login.dart';
import 'package:tankcare/string_values.dart';

class DistrictVendorDashboard extends StatefulWidget {
  @override
  DistrictVendorDashboardState createState() => DistrictVendorDashboardState();
}

class DistrictVendorDashboardState extends State<DistrictVendorDashboard> {
  Profile li;
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => DistrictVendorApprovalList()));
                },
