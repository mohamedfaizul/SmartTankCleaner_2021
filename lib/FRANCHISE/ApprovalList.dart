...
import 'package:tankcare/FRANCHISE/PropertyView.dart';
import 'package:tankcare/FRANCHISE/ServiceView.dart';
...
class FranchaiseApprovalList extends StatefulWidget {
  @override
  FranchaiseApprovalListState createState() => FranchaiseApprovalListState();
}

class FranchaiseApprovalListState extends State<FranchaiseApprovalList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    if (dropdownValue == '-- Approval Status --' &&
      ...
      url = String_values.base_url +
        ...
        dropdownValue2 == 'Property')
      url = String_values.base_url +
          'approval-functions-list?page=${page}&limit=10&ap_type=property';
    else if (dropdownValue == '-- Approval Status --' &&
    ...
    else if (dropdownValue == 'Pending' && dropdownValue2 == 'Property')
      url = String_values.base_url +
          'approval-functions-list?page=${page}&limit=10&ap_type=property&ap_status=P';
    ...
    else if (dropdownValue == 'Approved' && dropdownValue2 == 'Property')
      url = String_values.base_url +
          'approval-functions-list?page=${page}&limit=10&ap_type=property&ap_status=A';
    ...
    else if (dropdownValue == 'Rejected' && dropdownValue2 == 'Property')
      url = String_values.base_url +
          'approval-functions-list?page=${page}&limit=10&ap_type=property&ap_status=R';
  ...
  Future<int> uploadImage(apid, aputype, apuid) async {
    ...
    response.stream.transform(utf8.decoder).listen((value) {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (BuildContext context) => FranchaiseApprovalList(),
          ));
                                                    ...
                                                    if (value) {
                                                      if (list.apProcessName ==
                                                        ...
                                                        Navigator.pushReplacement(
                                                            context,
                                                            MaterialPageRoute(
                                                                builder: (context) => FranchaisePropertyView(
                                                                    propertyid: list
                                                                        .apTblId,
                                                                    apid: list
                                                                        .apId)));
                                                        ...
                                                        Navigator.pushReplacement(
                                                            context,
                                                            MaterialPageRoute(
                                                                builder: (context) => FranchaiseServiceView(
                                                                    propertyid: list
                                                                        .apTblId,
                                                                    apid: list
                                                                        .apId)));
  ...
  static Future<List> getSuggestions(String query) async {
    var url = //'http://35.184.156.126.xip.io/cyberhome/home.php?username=kavin&query=table';
        String_values.base_url +
            ...
            FranchaiseApprovalListState.roleid;
