...
class FranchaiseDamageView extends StatefulWidget {
  FranchaiseDamageView({Key key, this.propertyid, this.apid});

  String propertyid;
  String apid;

  @override
  FranchaiseDamageViewState createState() => FranchaiseDamageViewState();
}

class FranchaiseDamageViewState extends State<FranchaiseDamageView> {
  bool loading = false;
