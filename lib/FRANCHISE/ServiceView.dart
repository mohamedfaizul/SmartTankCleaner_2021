...
class FranchaiseServiceView extends StatefulWidget {
  FranchaiseServiceView({Key key, this.propertyid, this.apid});

  String propertyid;
  String apid;

  @override
  FranchaiseServiceViewState createState() => FranchaiseServiceViewState();
}

class FranchaiseServiceViewState extends State<FranchaiseServiceView> {
  bool loading = false;
  ...
  Future<int> uploadImage(apid, aptblid, Aorr) async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse(String_values.base_url + 'approval-service-verify'));
