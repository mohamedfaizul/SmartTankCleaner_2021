...
class FranchaisePropertyView extends StatefulWidget {
  FranchaisePropertyView({Key key, this.propertyid, this.apid});

  String propertyid;
  String apid;

  @override
  FranchaisePropertyViewState createState() => FranchaisePropertyViewState();
}

class FranchaisePropertyViewState extends State<FranchaisePropertyView> {
  bool loading = false;
  PropertyDetails li;
  List<File> files = [];
  var _kGooglePlex;
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: ExpansionTile(
                      ...
                      children: [
                        for (int i = 0; i < li.propertyImages.length; i++)
                          Padding(
                            padding: const EdgeInsets.all(18.0),
                            child: Container(
                                width: width / 2,
                                child: Image.network(
                                    li.propertyImages[i].imgPath)),
                          )
                      ],
                    ),
                  ),
