...
class VendorRepairQuoteApprovalView extends StatefulWidget {
  VendorRepairQuoteApprovalView({Key key, this.propertyid, this.apid});

  String propertyid;
  String apid;

  @override
  VendorRepairQuoteApprovalViewState createState() =>
      VendorRepairQuoteApprovalViewState();
}

class VendorRepairQuoteApprovalViewState
    extends State<VendorRepairQuoteApprovalView> {
  bool loading = false;
