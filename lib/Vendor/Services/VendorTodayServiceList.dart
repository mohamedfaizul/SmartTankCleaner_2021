...
class VendorTodayServiceList extends StatefulWidget {
  @override
  VendorTodayServiceListState createState() => VendorTodayServiceListState();
}

class VendorTodayServiceListState extends State<VendorTodayServiceList> {
  bool loading = false;
