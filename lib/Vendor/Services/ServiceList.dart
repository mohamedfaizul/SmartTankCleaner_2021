...
class VendorServiceList extends StatefulWidget {
  @override
  VendorServiceListState createState() => VendorServiceListState();
}

class VendorServiceListState extends State<VendorServiceList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    url = String_values.base_url +
        'property-plan-services?page=${page}&limit=10&sType=$stype&status=$stat&mobile_no=${searchController.text}&&from_date=${sql_dob_from}&to_date=${sql_dob_to}';
    print(url);
