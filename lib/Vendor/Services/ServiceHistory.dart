...
class ServiceHistoryList extends StatefulWidget {
  @override
  ServiceHistoryListState createState() => ServiceHistoryListState();
}

class ServiceHistoryListState extends State<ServiceHistoryList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    if (dropdownValue == '-- Approval Status --')
      url = String_values.base_url +
          'property-plan-services?page=${page}&limit=10?status=COMPLETED&search=${searchController.text}';
    else
      url = String_values.base_url +
