...
class VendorServiceDetail extends StatefulWidget {
  VendorServiceDetail({Key key, this.serviceid});

  String serviceid;

  @override
  VendorServiceDetailState createState() => VendorServiceDetailState();
}

class VendorServiceDetailState extends State<VendorServiceDetail> {
  bool loading = false;
  ...
  Future<http.Response> approval(planid) async {
    ...
    var url =
        String_values.base_url + 'ap-verify-details/' + planid + '/service';
    print(url);
  ...
  Future<http.Response> approval1(planid) async {
    setState(() {
      loading = true;
    });
    var url =
        String_values.base_url + 'ap-verify-details/' + planid + '/reservice';
    print(url);
    var response = await http.get(
      url,
      headers: {
    ...
    if (response.statusCode == 200) {
      ...
      li3 = APDetails.fromJson(json.decode(response.body));
      setState(() {
        // ServiceByController.text=li.planServices.se
        //
        // DamageCodeController.text=li4.items.damageCode;
  ...
  Future<http.Response> details(planid) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (li.property.latitude != null && li.property.longitude != null)
        _kGooglePlex = CameraPosition(
            // bearing: 192.8334901395799,
            target: LatLng(double.parse(li.property.latitude),
                double.parse(li.property.longitude)),
            zoom: 14);

      // ServiceByController.text=li.planServices.se
      ServiceStartDateController.text = DateFormat.yMMMd().format(DateTime.parse(li.planServices.pserviceDate.toString()));
      ...
      ServiceCodeController.text = li.planServices.pserviceCode.toString();
      ServiceTypeController.text =
          li.planServices.pserviceAssignUtype.toString();
      ...
      GroupCodeController.text = li.property.groupCode.toString();
      GroupNameController.text = li.property.groupName.toString();
      GroupAddressController.text = li.property.groupAddress.toString();
      GroupContactController.text = li.property.groupContactName.toString();
      GroupContactMobileController.text =
  ...
  TextEditingController ServiceCodeController = new TextEditingController();
...
//  TextEditingController SizeRangeControllermax = new TextEditingController();
  ...
  TextEditingController GroupAddressController = new TextEditingController();
  TextEditingController GroupContactController = new TextEditingController();
  ...
  void initState() {
    details(widget.serviceid)
        .then((value) => approval(widget.serviceid))
        .then((value) => approval1(widget.serviceid));
    sort = false;
    //stateRequest();
    //  districtRequest();
    selectedAvengers = [];
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: new TextField(
                                ...
                                decoration: InputDecoration(
                                  labelText: 'Group Contact Number',
                                  hintStyle: TextStyle(
                                    color: Colors.grey,
                                    fontSize: 16.0,
                                  ),
                            ...
                            (li.property.latitude != null &&
                                    li.property.longitude != null)
                                ? Container(
                                    padding: const EdgeInsets.only(
                                        left: 16, right: 16),
                                    height: height / 2,
