...
import 'package:tankcare/VendorModels/SpareRequestList.dart';

import 'package:tankcare/Vendor/Machines/SpareRequestList/SpareRequestDetail.dart';
import 'package:tankcare/Vendor/Machines/SpareRequestList/SpareRequestMachineTransfer.dart';

import '../../../string_values.dart';

class SpareRequestList extends StatefulWidget {
  @override
  SpareRequestListState createState() => SpareRequestListState();
}

class SpareRequestListState extends State<SpareRequestList> {
  bool loading = false;

  SpareRequestListings li;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'machine-spare-request-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = SpareRequestListings.fromJson(json.decode(response.body));
                            ...
                            (list) => DataRow(cells: [
                              ...
                              DataCell(Center(
                                ...
                                child: Wrap(
                                    ...
                                    alignment: WrapAlignment.center,
                                    children: [
                                      Text(list.machineName.toString(),
                                          textAlign: TextAlign.center)
                                    ]),
                              ))),
                              DataCell(
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.machineType.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.reqby.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              list.spareApproval.toString() == "A"
                                  ? DataCell(
                                      Center(
                                          child: Center(
                                              child: Wrap(
                                ...
                                DropdownButtonHideUnderline(
                                  child: DropdownButton<String>(
                                    ...
                                    onChanged: (String newValue) {
                                      setState(() {
                                        if (newValue == "Machine Transfer")
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (context) =>
                                                      SpareRequestMachineTransfer(
                                                          machineid:
                                                              list.machineId)));
...
//                                    }
                                    ...
                                    items: list.spareApproval.toString() == "A"
                                        ? <String>[
                                            '-Action-',
                                            "View",
                                            "Machine Transfer"
