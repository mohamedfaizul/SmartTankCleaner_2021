...
import 'package:tankcare/VendorModels/SpareList.dart';

import 'package:tankcare/Vendor/Machines/Spare%20List/SpareRequest.dart';

import '../../../string_values.dart';

class SpareList extends StatefulWidget {
  @override
  SpareListState createState() => SpareListState();
}

class SpareListState extends State<SpareList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'machine-spare-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = SpareListings.fromJson(json.decode(response.body));
