...
class SpareRequest extends StatefulWidget {
  SpareRequest({Key key, this.machineid});
...
class SpareRequestState extends State<SpareRequest> {
  ...
  Future<int> uploadImage() async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse(String_values.base_url + 'machine-spare-request'));
    ...
    request.fields['spare_note'] = DescriptionController.text;
  ...
  Future<http.Response> details(planid) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        if (li.values.machineStatus.toString() == "A")
          MachineStatusController.text = "Active";
        else
          MachineStatusController.text = "InActive";
      });
  ...
  TextEditingController MachineStatusController = new TextEditingController();
