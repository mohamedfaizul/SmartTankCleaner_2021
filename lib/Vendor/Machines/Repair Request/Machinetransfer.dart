...
class MachineTransfer extends StatefulWidget {
  MachineTransfer({Key key, this.propertyid});

  String propertyid;

  // String apid;
  @override
  MachineTransferState createState() => MachineTransferState();
}

class MachineTransferState extends State<MachineTransfer> {
  bool loading = false;
  ...
  Future<http.Response> details(planid) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        RepairChargeController.text = li.data.repairCharge.toString();
  ...
  Future<int> uploadImage(
    ...
    request.fields['machine_id'] = widget.propertyid;
    request.fields['receiver_uid'] = userid;
    request.fields['receiver_utype'] = usertype;
    request.fields['sender_uid'] = MyApp.role;
...
//  TextEditingController SizeRangeControllermax = new TextEditingController();
  ...
  void initState() {
    ...
    // print(widget.apid);
    details(widget.propertyid).then((value) => getdesignation());
    super.initState();
  }
                      ...
                      child: ExpansionTile(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: new TextField(
                                enabled: false,
                                controller: RepairChargeController,
                                decoration: InputDecoration(
                                  labelText: 'Repair Charge',
                                  hintStyle: TextStyle(
                                    color: Colors.grey,
                                    fontSize: 16.0,
                                  ),
