...
import 'package:tankcare/VendorModels/RepairList.dart';

import 'package:tankcare/Vendor/Machines/Repair%20Request/Machinetransfer.dart';
import 'package:tankcare/Vendor/Machines/Repair%20Request/RepairQuotefromRepairRequest.dart';
import 'package:tankcare/Vendor/Machines/Repair%20Request/RepairRequestview.dart';

import '../../../string_values.dart';

class RepairQUoteList extends StatefulWidget {
  @override
  RepairQUoteListState createState() => RepairQUoteListState();
}

class RepairQUoteListState extends State<RepairQUoteList> {
  bool loading = false;

  MachineRepairListings li;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'machine-repair-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = MachineRepairListings.fromJson(json.decode(response.body));
                      ...
                      Center(
                          child: Center(
                              child: Wrap(
                                  ...
                                  alignment: WrapAlignment.center,
                                  children: [
                                    Text(list.machineUtype.toString(),
                                        textAlign: TextAlign.center)
                                  ]))),
                    ),
                    DataCell(
                      ...
                      Center(
                          child: Center(
                              child: Wrap(
                                  ...
                                  children: [
                                    Text(
                                        list.repairApproval.toString() == "A"
                                            ? "Approved"
                                            : "Pending",
                                        textAlign: TextAlign.center)
                                  ]))),
                      ...
                      Center(
                          child: Center(
                              child: Wrap(
                                  ...
                                  children: [
                                    Text(
                                        list.repairQuoteApproval.toString() ==
                                            "A"
                                            ? "Approved"
                                            : "Pending",
                                        textAlign: TextAlign.center)
                            ...
                            setState(() {
                              if (newValue == "View")
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            RepairQuotefromRepairRequest(
                                              propertyid:
                                              list.repairId,
                                            )));
                              else if (newValue == "Machine Transfer")
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) =>
...
//                                    }
                          ...
                          items: list.repairApproval.toString() ==
                              "A" &&
                              list.repairQuoteApproval
                                  .toString() ==
                                  "P"
                              ? <String>[
                            '-Action-',
