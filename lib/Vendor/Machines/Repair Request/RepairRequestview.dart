...
class RepairRequestView extends StatefulWidget {
  RepairRequestView({Key key, this.propertyid});

  String propertyid;

  // String apid;
  @override
  RepairRequestViewState createState() => RepairRequestViewState();
}

class RepairRequestViewState extends State<RepairRequestView> {
  bool loading = false;
