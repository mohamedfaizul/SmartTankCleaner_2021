...
class EmployeeDamageList extends StatefulWidget {
  @override
  EmployeeDamageListState createState() => EmployeeDamageListState();
}

class EmployeeDamageListState extends State<EmployeeDamageList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'service-damage-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = DamageListings.fromJson(json.decode(response.body));
                                ...
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.damageStatus.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
