...
import 'package:tankcare/VendorModels/InvoiceView.dart';

import '../../string_values.dart';

class VendorInvoiceDetail extends StatefulWidget {
  VendorInvoiceDetail({Key key, this.billid});

  String billid;

  @override
  VendorInvoiceDetailState createState() => VendorInvoiceDetailState();
}

class VendorInvoiceDetailState extends State<VendorInvoiceDetail> {
  bool loading = false;
  VendorInvoiceView li;
  ...
  Future<http.Response> details(planid) async {
    ...
    var url = String_values.base_url + 'servicer-inv-view?invno=' + planid;
    ...
    if (response.statusCode == 200) {
      ...
      li = VendorInvoiceView.fromJson(json.decode(response.body));
      print(json.decode(response.body));
      vendorNameController.text = li.data.inv.vendorName.toString();
      vendorEmailController.text = li.data.inv.vendorEmail.toString();
      vendorPhoneController.text = li.data.inv.vendorPhone.toString();
      vendorAddressController.text = li.data.inv.vendorAddress.toString();
      vendorGSTController.text = li.data.inv.vendorGst.toString();

      BillNoController.text = li.data.inv.sbillInvno.toString();
      BillDateController.text = DateFormat('dd/MM/yyyy').format(
          DateTime.parse(li.data.inv.sbillInvDate.toString()));
      BillNoteController.text = li.data.inv.totamnt.toString();
      BillStatusController.text = li.data.inv.totcnt.toString();
  ...
  TextEditingController vendorGSTController = new TextEditingController();
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: new TextFormField(
                        controller: vendorGSTController,
                        enabled: false,
                        decoration: InputDecoration(
