...
import 'package:tankcare/VendorModels/InvoiceList.dart';

import '../../string_values.dart';
import 'InvoiceDetail.dart';

class VendorInvoiceList extends StatefulWidget {
  @override
  VendorInvoiceListState createState() => VendorInvoiceListState();
}

class VendorInvoiceListState extends State<VendorInvoiceList> {
  bool loading = false;

  VendorInvoiceListings li;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'servicer-inv-list?search=${searchController.text}&page=${page}&limit=10&from_date=$sql_dob_from&to_date=$sql_dob_to&verify_status=$stat';
    ...
    if (response.statusCode == 200) {
      ...
      if (response.body.toString().contains("true"))
        li = VendorInvoiceListings.fromJson(json.decode(response.body));
