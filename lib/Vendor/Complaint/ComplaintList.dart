...
import 'package:tankcare/VendorModels/ComplaintListings.dart';
...
class ComplaintListState extends State<ComplaintList> {
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'service-complaint-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = ComplaintListings.fromJson(json.decode(response.body));
                                ...
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.complaintStatus.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
