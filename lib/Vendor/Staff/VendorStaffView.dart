...
class VendorStaffView extends StatefulWidget {
  VendorStaffView({Key key, this.id});

  String id;

  @override
  VendorStaffViewState createState() => VendorStaffViewState();
}

class VendorStaffViewState extends State<VendorStaffView> {
...
//    print("response: ${PlanServiceYearClass.toJson()}");
  ...
  Future<http.Response> details(planid) async {
    ...
    if (response.statusCode == 200) {
      ...
      li = VendorStaffDetails.fromJson(json.decode(response.body));
      setState(() {
        this._typeAheadController.text = li.items.stationName.toString();
        NameController.text = li.items.staffName.toString();
        MobileController.text = li.items.staffPhone.toString();
        AlertMobileController.text = li.items.staffPhoneAlter.toString();
        EmailController.text = li.items.staffEmail.toString();
        datefromcontroller.text = DateFormat('dd/MM/yyyy').format(
            DateTime.parse(li.items.staffDob.toString()));
        datetocontroller.text =DateFormat('dd/MM/yyyy').format(
            DateTime.parse( li.items.staffDoj.toString()));
        GenderController.text = li.items.staffGender.toString();
        StateController.text = li.items.stateName.toString();
        DistrictController.text = li.items.districtName.toString();
        PincodeController.text = li.items.staffPincode.toString();
        AddressController.text = li.items.staffAddress.toString();
        li1 = AccDetails.fromJson(json.decode(li.items.staffBankDetails));
        AccountNameController.text = li1.staffAccName.toString();
        AccountNoController.text = li1.staffAccNo.toString();
        IFSCController.text = li1.staffAccIfsc.toString();
        BranchNameController.text = li1.staffAccBranch.toString();
        BankNameController.text = li1.staffAccBank.toString();
                  ...
                  Container(
                      ...
                      child: ExpansionTile(
                          ...
                          children: [
                            ...
                            li.items.staffPhotos.toString()!="null"?Container(
                              child: Column(
                                children: [
                                  GridView.count(
                            ...
                            li.items.staffProofs.toString()!="null"? Container(
                              child: Column(
                                children: [
                                  GridView.count(
                                    physics: ScrollPhysics(),
