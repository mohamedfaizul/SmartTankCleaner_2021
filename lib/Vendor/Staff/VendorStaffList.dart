...
import 'package:tankcare/Vendor/Staff/VendorStaffAdd.dart';
import 'package:tankcare/Vendor/Staff/VendorStaffEdit.dart';
import 'package:tankcare/Vendor/Staff/VendorStaffView.dart';
import 'package:tankcare/VendorModels/MenuModel.dart';
import 'package:tankcare/VendorModels/VendorStaffListModel.dart';

import '../../string_values.dart';

class VendorStaffList extends StatefulWidget {
  @override
  VendorStaffListState createState() => VendorStaffListState();
}

class VendorStaffListState extends State<VendorStaffList> {
  bool loading = false;

  VendorStaffListModel li;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'vendor-staff-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = VendorStaffListModel.fromJson(json.decode(response.body));
  ...
  Future<http.Response> delete(planid) async {
    ...
    var url = String_values.base_url + 'vendor-staff-delete/' + planid;
    print(String_values.base_url);
    var response = await http.get(
      url,
      headers: {
                                ...
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.staffPassword.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.stationName.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              list.staffApproval.toString() == "A"
                                  ? DataCell(
                                      Center(
                                          child: Center(
                                              child: Wrap(
                                      ...
                                      setState(() {
                                        if (newValue == "View")
                                          ...
                                          Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                  builder: (context) =>
                                                      VendorStaffEdit(id: list.staffId)));
                                      });
