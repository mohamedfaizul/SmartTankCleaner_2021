...
import 'package:tankcare/VendorModels/CreditNoteList.dart';

import 'package:tankcare/Vendor/Credit%20Note/CreditNoteDetail.dart';

import '../../string_values.dart';

class CreditNoteList extends StatefulWidget {
  @override
  CreditNoteListState createState() => CreditNoteListState();
}

class CreditNoteListState extends State<CreditNoteList> {
  bool loading = false;

  CreditNoteListings li;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'credit-note-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = CreditNoteListings.fromJson(json.decode(response.body));
  ...
  String dropdownValue2 = '-- Credit Type --';
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        //   child: FlatButton(
                        //     onPressed: () {
                        //       Navigator.push(context,MaterialPageRoute(builder: (context) => CreditNoteAdd()));
                        //     },
                        //     child: Text(
                        //       "Add Credit Note",
                            ...
                            (list) => DataRow(cells: [
                              DataCell(Center(
                                ...
                                child: Wrap(
                                    ...
                                    children: [
                                      Text(
                                    DateFormat.yMd().format(DateTime.parse(list.cnoteDate.toString())),
                                        textAlign: TextAlign.center,
                                      )
                                    ]),
                              ))),
                                ...
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.cnoteAccType.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
