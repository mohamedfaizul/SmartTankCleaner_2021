...
class ServiceStationList extends StatefulWidget {
  @override
  ServiceStationListState createState() => ServiceStationListState();
}

class ServiceStationListState extends State<ServiceStationList> {
  bool loading = false;

  ServiceStationListings li;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'service-station-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = ServiceStationListings.fromJson(json.decode(response.body));
                                ...
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      if (list.stationStatus.toString() == "A")
                                        Text("Active",
                                            textAlign: TextAlign.center)
                                      else if (list.stationStatus.toString() ==
                                          "P")
                                        Text("Pending",
                                            textAlign: TextAlign.center)
                                    ]))),
