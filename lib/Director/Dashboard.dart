...
import 'package:tankcare/Director/ApprovalList.dart';
import 'package:tankcare/Vendor/Login/Login.dart';
import 'package:tankcare/string_values.dart';

class DirectorDashboard extends StatefulWidget {
  @override
  DirectorDashboardState createState() => DirectorDashboardState();
}

class DirectorDashboardState extends State<DirectorDashboard> {
  Profile li;
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => DirectorApprovalList()));
                },
