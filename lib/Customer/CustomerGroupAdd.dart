...
import 'package:tankcare/main.dart';
class CustomerGroupAdd extends StatefulWidget {
  @override
  CustomerGroupAddState createState() => CustomerGroupAddState();
}

class CustomerGroupAddState extends State<CustomerGroupAdd> {
