...
class RMDamageView extends StatefulWidget {
  RMDamageView({Key key, this.propertyid, this.apid});

  String propertyid;
  String apid;

  @override
  RMDamageViewState createState() => RMDamageViewState();
}

class RMDamageViewState extends State<RMDamageView> {
  bool loading = false;
