...
class ReServiceView extends StatefulWidget {
  ReServiceView({Key key, this.propertyid, this.apid});

  String propertyid;
  String apid;

  @override
  ReServiceViewState createState() => ReServiceViewState();
}

class ReServiceViewState extends State<ReServiceView> {
  bool loading = false;
