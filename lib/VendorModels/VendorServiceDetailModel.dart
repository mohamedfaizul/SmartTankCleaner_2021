...
class PlanServices {
  ...
  PlanServices(
      ...
      this.pserviceAssignStationId,
      this.servicerUid,
      this.pserviceCusRemark,
      this.pserviceNote,
      this.pserviceStatus,
      this.pserviceApproval,
      this.pserviceReserviceApproval,
      this.pserviceType,
      this.reserviceId,
      this.createdUtype,
      this.createdAt,
  ...
  PlanServices.fromJson(Map<String, dynamic> json) {
    ...
    pserviceServicerAmnt = json['pservice_servicer_amnt'];
    ...
    if (json['pservice_before_img'] != "") {
      pserviceBeforeImg = new List<PserviceBeforeImg>();
      json['pservice_before_img'].forEach((v) {
        pserviceBeforeImg.add(new PserviceBeforeImg.fromJson(v));
      });
    }
    if (json['pservice_after_img'] != "") {
      pserviceAfterImg = new List<PserviceAfterImg>();
      json['pservice_after_img'].forEach((v) {
        pserviceAfterImg.add(new PserviceAfterImg.fromJson(v));
      });
    }
    ...
    pserviceAssignStationId = json['pservice_assign_station_id'];
    servicerUid = json['servicer_uid'];
    ...
    pserviceReserviceApproval = json['pservice_reservice_approval'];
    pserviceType = json['pservice_type'];
    reserviceId = json['reservice_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['pservice_servicer_amnt'] = this.pserviceServicerAmnt;
    ...
    if (this.pserviceBeforeImg != null) {
      data['pservice_before_img'] =
          this.pserviceBeforeImg.map((v) => v.toJson()).toList();
    }
    if (this.pserviceAfterImg != null) {
      data['pservice_after_img'] =
          this.pserviceAfterImg.map((v) => v.toJson()).toList();
    }
    ...
    data['pservice_assign_station_id'] = this.pserviceAssignStationId;
    data['servicer_uid'] = this.servicerUid;
    ...
    data['pservice_reservice_approval'] = this.pserviceReserviceApproval;
    data['pservice_type'] = this.pserviceType;
    data['reservice_id'] = this.reserviceId;
...
class PserviceBeforeImg {
  String imgId;
  String imgPath;

  PserviceBeforeImg({this.imgId, this.imgPath});

  PserviceBeforeImg.fromJson(Map<String, dynamic> json) {
    imgId = json['img_id'];
...
class PserviceAfterImg {
  String imgId;
  String imgPath;

  PserviceAfterImg({this.imgId, this.imgPath});

  PserviceAfterImg.fromJson(Map<String, dynamic> json) {
    imgId = json['img_id'];
    imgPath = json['img_path'];
  }
