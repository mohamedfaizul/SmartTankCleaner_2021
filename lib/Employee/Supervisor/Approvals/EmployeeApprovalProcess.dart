...
import 'package:tankcare/Employee/Supervisor/Approvals/EmployeeApprovalView.dart';
...
class EmployeeApprovalList extends StatefulWidget {
  @override
  EmployeeApprovalListState createState() => EmployeeApprovalListState();
}

class EmployeeApprovalListState extends State<EmployeeApprovalList> {
  bool loading = false;
  ...
  static Future<List> getSuggestions(String query) async {
    var url = //'http://35.184.156.126.xip.io/cyberhome/home.php?username=kavin&query=table';
        String_values.base_url +
            ...
            EmployeeApprovalListState.roleid;
