...
import 'package:tankcare/Employee/Supervisor/Customer/EmployeeCustomerAdd.dart';
import 'package:tankcare/Employee/Supervisor/Customer/EmployeeCustomerEdit.dart';
import 'package:tankcare/Employee/Supervisor/Customer/EmployeeCustomerView.dart';
...
class EmployeeCustomerList extends StatefulWidget {
  @override
  EmployeeCustomerListState createState() => EmployeeCustomerListState();
}

class EmployeeCustomerListState extends State<EmployeeCustomerList> {
  bool loading = false;

  VendorCustomerListModel li;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'cus-list?search=${searchController.text}&page=${page}&limit=10';
