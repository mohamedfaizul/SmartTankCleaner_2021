...
class EmployeeLeadAdd extends StatefulWidget {
  EmployeeLeadAdd({Key key, this.id});

  String id;

  @override
  EmployeeLeadAddState createState() => EmployeeLeadAddState();
}

class EmployeeLeadAddState extends State<EmployeeLeadAdd> {
...
//    print("response: ${PlanServiceYearClass.toJson()}");
  ...
  Widget build(BuildContext context) {
    Future<int> uploadImage() async {
      ...
      request.fields['cus_id']= BackendService.li1.data.cusId;
      request.fields['cus_name']= BackendService.li1.data.cusName;
      request.fields['cus_email']= BackendService.li1.data.cusEmail;
      request.fields['cus_address']= BackendService.li1.data.cusAddress;
      request.fields['cus_state']= BackendService.li1.data.stateId;
      request.fields['cus_district']= BackendService.li1.data.districtId;
      request.fields['cus_pincode']= BackendService.li1.data.cusPincode;
      ...
      request.fields['lead_follow_uid']= li6.data.followUid;
  ...
  static Future<List> getSuggestions(String query) async {
    if (query.length == 10) {
      ...
      if (response.statusCode == 200) {
        ...
        EmployeeLeadAddState.EmailController.text = li1.data.cusEmail.toString();
        EmployeeLeadAddState.CusCodeController.text = li1.data.cusCode.toString();
        ;
        EmployeeLeadAddState.addressController.text = li1.data.cusAddress.toString();
        ;
        EmployeeLeadAddState.NameController.text = li1.data.cusName.toString();
        ;
        EmployeeLeadAddState.StateController.text = li1.data.stateName.toString();
        ;
        EmployeeLeadAddState.DistrictController.text = li1.data.districtName.toString();
        ;

        EmployeeLeadAddState.PincodeController.text = li1.data.cusPincode.toString();
