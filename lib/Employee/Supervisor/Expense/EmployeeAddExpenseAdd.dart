...
class EmployeeAddExpenseType extends StatefulWidget {
  @override
  EmployeeAddExpenseTypeState createState() => EmployeeAddExpenseTypeState();
}

class EmployeeAddExpenseTypeState extends State<EmployeeAddExpenseType> {
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                          ...
                          child: FlatButton(
                            onPressed: () {
                              if (_typeAheadController1.text.length != 0)
...
class BackendService1 {
  ...
  static Future<List> getSuggestions(String query) async {
    ...
    String_values.base_url +
        ...
        EmployeeAddExpenseTypeState.roleid;
