...
class EmployeeMachineDetail extends StatefulWidget {
  EmployeeMachineDetail({Key key, this.machineid});

  String machineid;

  @override
  EmployeeMachineDetailState createState() => EmployeeMachineDetailState();
}

class EmployeeMachineDetailState extends State<EmployeeMachineDetail> {
  bool loading = false;
  MachineView li;
  MachineHistory li2;
...
//  TextEditingController SizeRangeControllermax = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    DateTime.parse(list.historyDate.toString())),
                                                  textAlign: TextAlign.center)),
                                        ),
                                        DataCell(
                                          Center(
                                              child: Text(
                                                  list.historyType.toString(),
                                                  textAlign: TextAlign.center)),
                                        ),
                                        DataCell(
                                          Center(
                                              child: Text(
                                                  list.fromBy.toString(),
                                                  textAlign: TextAlign.center)),
                                        ),
                                        DataCell(
                                          Center(
                                              child: Text(list.toBy.toString(),
                                                  textAlign: TextAlign.center)),
                                        ),
                                      ]),
                                    )
