...
import 'package:tankcare/Employee/Supervisor/Machines/MachineDetail.dart';
import 'package:tankcare/VendorModels/MachineListings.dart';
import 'package:tankcare/string_values.dart';

class EmployeeMachineList extends StatefulWidget {
  @override
  EmployeeMachineListState createState() => EmployeeMachineListState();
}

class EmployeeMachineListState extends State<EmployeeMachineList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'machine-assign-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = MachineListings.fromJson(json.decode(response.body));
                                ...
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.machineAssignUtype.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
