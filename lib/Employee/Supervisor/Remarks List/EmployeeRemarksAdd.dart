...
class EmployeeRemarksAdd extends StatefulWidget {
  @override
  EmployeeRemarksAddState createState() => EmployeeRemarksAddState();
}

class EmployeeRemarksAddState extends State<EmployeeRemarksAdd> {
...
class BackendService1 {
  ...
  static Future<List> getSuggestions(String query) async {
    ...
    url = String_values.base_url +
        'role-user-list?urole_id=${EmployeeRemarksAddState.roleid}&search=${query}';
    var response = await http.get(
      url,
      headers: {
        "Content-Type": "application/json",
...
class BackendService2 {
  ...
  static Future<List> getSuggestions1(String query) async {
    ...
    url = String_values.base_url +
        'remark-type-mob-search?urole_id=${EmployeeRemarksAddState.roleid}&search=${query}';
    var response = await http.get(
      url,
      headers: {
        "Content-Type": "application/json",
