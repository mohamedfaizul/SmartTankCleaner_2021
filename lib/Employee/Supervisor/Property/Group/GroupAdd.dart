...
class EmployeeGroupAdd extends StatefulWidget {
  @override
  EmployeeGroupAddState createState() => EmployeeGroupAddState();
}

class EmployeeGroupAddState extends State<EmployeeGroupAdd> {
