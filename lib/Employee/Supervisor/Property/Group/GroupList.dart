...
class EmployeeGroupList extends StatefulWidget {
  @override
  EmployeeGroupListState createState() => EmployeeGroupListState();
}

class EmployeeGroupListState extends State<EmployeeGroupList> {
  bool loading = false;
                                        ...
                                        if (newValue == "View")
                                          ...
                                          check().then((value) {
                                            if (value)
                                              ...
                                              //   title: 'Are you sure?',
                                              //   desc: 'Do you want to delete this!',
                                              //   btnCancelOnPress: () {},
                                              //   btnOkOnPress: () {delete(list.groupId);},
                                              // )..show();
