...
class EmployeePropertyView extends StatefulWidget {
  EmployeePropertyView({Key key, this.propertyid});

  String propertyid;

  @override
  _EmployeePropertyViewState createState() => _EmployeePropertyViewState();
}

class _EmployeePropertyViewState extends State<EmployeePropertyView> {
  bool loading = false;
