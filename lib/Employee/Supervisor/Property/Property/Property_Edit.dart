...
class EmployeePropertyEdit extends StatefulWidget {
  EmployeePropertyEdit({Key key, this.propertyid});

  String propertyid;
  final String title = "AutoComplete Demo";

  @override
  EmployeePropertyEditState createState() => EmployeePropertyEditState();
}

class EmployeePropertyEditState extends State<EmployeePropertyEdit> {
