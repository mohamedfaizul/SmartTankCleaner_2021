...
class EmployeePlanEdit extends StatefulWidget {
  EmployeePlanEdit({Key key, this.planid});

  String planid;

  @override
  EmployeePlanEditState createState() => EmployeePlanEditState();
}

class EmployeePlanEditState extends State<EmployeePlanEdit> {
  bool loading = false;
