...
class EmployeePlanDetail extends StatefulWidget {
  EmployeePlanDetail({Key key, this.planid});

  String planid;

  @override
  EmployeePlanDetailState createState() => EmployeePlanDetailState();
}

class EmployeePlanDetailState extends State<EmployeePlanDetail> {
  bool loading = false;
