...
class EmployeePlanList extends StatefulWidget {
  @override
  EmployeePlanListState createState() => EmployeePlanListState();
}

class EmployeePlanListState extends State<EmployeePlanList> {
  bool loading = false;
        ...
        for (int i = 0; i < li3.list.length; i++)
          if (li3.list[i].title == "Property") {
            for (int j = 0; j < li3.list[i].children.length; j++)
              if (li3.list[i].children[j].title == "Property Plan List") {
