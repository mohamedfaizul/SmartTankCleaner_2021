...
import 'package:tankcare/Employee/Supervisor/My%20Shop/EmployeeAddTentalShop.dart';
import 'package:tankcare/Employee/Supervisor/My%20Shop/EmployeeEditShop.dart';
import 'package:tankcare/Employee/Supervisor/My%20Shop/EmployeeMyShopView.dart';
import 'package:tankcare/VendorModels/MenuModel.dart';
import 'package:tankcare/string_values.dart';

class EmployeeMyShopList extends StatefulWidget {
  @override
  EmployeeMyShopListState createState() => EmployeeMyShopListState();
}

class EmployeeMyShopListState extends State<EmployeeMyShopList> {
  bool loading = false;

  DVShopDropdownModel li;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'shop-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = DVShopDropdownModel.fromJson(json.decode(response.body));
          ...
          if (li3.list[i].title == "My Shop") {
            if (li3.list[i].children.toString() == "null") {
              ...
              for (int j = 0; j < li3.list[i].children.length; j++)
                if (li3.list[i].children[j].title == "Customer List") {
  ...
  Future<http.Response> delete(planid) async {
    ...
    var url = String_values.base_url + 'shop-delete/' + planid;
    print(String_values.base_url);
    var response = await http.get(
      url,
      headers: {
                            ...
                            (list) => DataRow(cells: [
                              ...
                              DataCell(Center(
                                ...
                                child: Wrap(
                                    ...
                                    alignment: WrapAlignment.center,
                                    children: [
                                      Text(list.shopDeposit.toString(),
                                          textAlign: TextAlign.center)
                                    ]),
                              ))),
                              DataCell(
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.shopOwnerName.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.shopOwnerPhone.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
