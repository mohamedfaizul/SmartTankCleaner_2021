...
import 'DVStaffList.dart';

class EmployeeAddStaff extends StatefulWidget {
  @override
  EmployeeAddStaffState createState() => EmployeeAddStaffState();
}

class EmployeeAddStaffState extends State<EmployeeAddStaff> {
                            ...
                            Padding(
                              ...
                              child: TypeAheadFormField(
                                ...
                                onSuggestionSelected: (suggestion) {
                                  for (int i = 0;i < BackendService.li1.values.length;
                                      i++) {
