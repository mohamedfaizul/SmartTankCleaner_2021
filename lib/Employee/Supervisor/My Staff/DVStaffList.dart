...
import 'package:tankcare/Employee/EmployeeModels/DVStaff/DVStaffList.dart';
import 'package:tankcare/Employee/Supervisor/My%20Staff/DVStaffAdd.dart';
import 'package:tankcare/Employee/Supervisor/My%20Staff/DVStaffEdit.dart';
...
class EmployeeDVStaffList extends StatefulWidget {
  @override
  EmployeeDVStaffListState createState() => EmployeeDVStaffListState();
}

class EmployeeDVStaffListState extends State<EmployeeDVStaffList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'dvendor-staff-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = DVStaffList.fromJson(json.decode(response.body));
  ...
  Future<http.Response> delete(planid) async {
    ...
    var url = String_values.base_url + 'dvendor-staff-delete/' + planid;
    print(String_values.base_url);
    var response = await http.get(
      url,
      headers: {
                            ...
                            (list) => DataRow(cells: [
                              ...
                              DataCell(Center(
                                ...
                                child: Wrap(
                                    ...
                                    alignment: WrapAlignment.center,
                                    children: [
                                      Text(list.dstaffEmail.toString(),
                                          textAlign: TextAlign.center)
                                    ]),
                              ))),
                              DataCell(
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.dstaffPhone.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.dstaffPassword.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
                                Center(
                                    child: Center(
                                        child: Wrap(
                                            ...
                                            alignment: WrapAlignment.center,
                                            children: [
                                      Text(list.shopName.toString(),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              list.dstaffApproval.toString() == "A"
                                  ? DataCell(
                                      Center(
                                          child: Center(
                                              child: Wrap(
