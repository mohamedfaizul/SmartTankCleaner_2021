...
import 'package:tankcare/Employee/EmployeeModels/DVStaff/DVShopDropdownModel.dart';
...
class DVStaffEdit extends StatefulWidget {
  DVStaffEdit({Key key, this.id});

  String id;

  @override
  DVStaffEditState createState() => DVStaffEditState();
}

class DVStaffEditState extends State<DVStaffEdit> {
  ...
  Future<http.Response> details(planid) async {
    ...
    if (response.statusCode == 200) {
      ...
      li6 = DVStaffDetailModel.fromJson(json.decode(response.body));
      setState(() {
        this._typeAheadController.text = li6.items.shopName.toString();
        NameController.text = li6.items.dstaffName.toString();
        MobileController.text = li6.items.dstaffPhone.toString();
        AlertMobileController.text = li6.items.dstaffPhoneAlter.toString();
        EmailController.text = li6.items.dstaffEmail.toString();
        datefromcontroller.text =   DateFormat('dd/MM/yyyy').format(
            DateTime.parse(li6.items.dstaffDob.toString()));
        datetocontroller.text =   DateFormat('dd/MM/yyyy').format(
            DateTime.parse(li6.items.dstaffDoj.toString()));
        dropdownValue = li6.items.dstaffGender.toString();
        dropdownValue1 = li6.items.stateName.toString();
        sql_dob_from = li6.items.dstaffDob;
        sql_dob_to = li6.items.dstaffDoj;
        districtRequest(li6.items.dstaffState).then((value) {
          setState(() {
            dropdownValue2 = li6.items.districtName.toString();
          });
        });
        // DistrictController.text=li6.items.districtName.toString();
        PincodeController.text = li6.items.dstaffPincode.toString();
        addressController.text = li6.items.dstaffAddress.toString();
        li61 = DAccDetails.fromJson(json.decode(li6.items.dstaffBankDetails));
        AccountNameController.text = li61.dstaffAccName.toString();
        AccountNoController.text = li61.dstaffAccNo.toString();
        IFSCController.text = li61.dstaffAccIfsc.toString();
        BranchNameController.text = li61.dstaffAccBranch.toString();
        BankNameController.text = li61.dstaffAccBank.toString();

        statetype = int.parse(li6.items.dstaffState);
        districttype = int.parse(li6.items.dstaffDistrict);
        shopid = li6.items.shopId;
...
//    print("response: ${PlanServiceYearClass.toJson()}");
  ...
  Widget build(BuildContext context) {
    Future<int> uploadImage() async {
      ...
      var request = http.MultipartRequest(
          'POST', Uri.parse(String_values.base_url + 'dvendor-staff-add'));
      //property_id plan_id pplan_name pplan_year pplan_service pplan_price pplan_tot_price pplan_start_date
      request.headers.addAll(headers);
      for (int i = 0; i < files.length; i++) {
        request.files.add(await http.MultipartFile.fromPath(
            'dstaff_photos[]', files[i].path));
        print(files[i].path);
      }
      for (int i = 0; i < files1.length; i++) {
        request.files.add(await http.MultipartFile.fromPath(
            'dstaff_proofs[]', files1[i].path));
        print(files1[i].path);
      }
      request.fields['dstaff_name'] = NameController.text;
      request.fields['dstaff_phone'] = MobileController.text;
      request.fields['dstaff_phone_alter'] = AlertMobileController.text;
      request.fields['dstaff_email'] = EmailController.text;
      request.fields['dstaff_gender'] = dropdownValue.toUpperCase();
      request.fields['dstaff_dob'] = sql_dob_from;

      request.fields['dstaff_doj'] = sql_dob_to;
      request.fields['dstaff_address'] = addressController.text.toString();
      request.fields['dstaff_pincode'] = PincodeController.text.toString();
      request.fields['dstaff_district'] = districttype.toString();
      request.fields['dstaff_state'] = statetype.toString();

      request.fields['dstaff_acc_name'] = AccountNameController.text;
      request.fields['dstaff_acc_no'] = AccountNoController.text.toString();
      request.fields['dstaff_acc_branch'] =
          BranchNameController.text.toString();
      request.fields['dstaff_acc_bank'] = BankNameController.text.toString();
      request.fields['dstaff_acc_ifsc'] = IFSCController.text.toString();
      request.fields['dstaff_shop'] = shopid;
      request.fields['dstaff_id'] = widget.id;
                              ...
                              child: TypeAheadFormField(
                                ...
                                onSuggestionSelected: (suggestion) {
                                  for (int i = 0;
                                      ...
                                      i++) {
                                   if(BackendService.li1.values[i].shopName==suggestion)
                                    shopid = BackendService.li1.values[i].shopId
                                        .toString();
...
//    var dir = await path_provider.getTemporaryDirectory();
  ...
  Widget buildGridView2() {
    return li6.items.dstaffProofs.length != 0
        ? Padding(
            padding: const EdgeInsets.all(8.0),
            child: GridView.count(
              physics: ScrollPhysics(),
                ...
                (index) {
                  return Padding(
                    ...
                    child: Card(
                        ...
                        clipBehavior: Clip.antiAlias,
                        child: Stack(children: <Widget>[
                          index < li6.items.dstaffProofs.length
                              ? InkWell(
                                  onTap: () {
                                    showDialog(
                                        context: context,
                                        child: Image.network(li6.items
                                            .dstaffProofs[index].imgPath));
                                  },
                                  child: Image.network(
                                    li6.items.dstaffProofs[index].imgPath,
                                    width: 300,
                                    height: 300,
                                  ),
                                )
                              ...
                              ? Positioned(
                                  ...
                                  child: InkWell(
                                      ...
                                      onTap: () {
                                        setState(() {
                                          deleteimage(li6
                                              .items.dstaffProofs[index].imgId);
                                          li6.items.dstaffProofs
                                              .removeAt(index);
                                          print(files);
                                          // images.replaceRange(index, index + 1, ['Add Image']);
                                        });
  ...
  Widget buildGridView3() {
    return li6.items.dstaffPhotos.length != 0
        ? Padding(
            padding: const EdgeInsets.all(8.0),
            child: GridView.count(
              physics: ScrollPhysics(),
                ...
                (index) {
                  return Padding(
                    ...
                    child: Card(
                        ...
                        clipBehavior: Clip.antiAlias,
                        child: Stack(children: <Widget>[
                          index < li6.items.dstaffPhotos.length
                              ? InkWell(
                                  onTap: () {
                                    showDialog(
                                        context: context,
                                        child: Image.network(li6.items
                                            .dstaffPhotos[index].imgPath));
                                  },
                                  child: Image.network(
                                    li6.items.dstaffPhotos[index].imgPath,
                                    width: 300,
                                    height: 300,
                                  ),
                                )
                              ...
                              ? Positioned(
                                  ...
                                  child: InkWell(
                                      ...
                                      onTap: () {
                                        setState(() {
                                          deleteimage(li6
                                              .items.dstaffPhotos[index].imgId);
                                          li6.items.dstaffPhotos
                                              .removeAt(index);
                                          print(files);
                                          // images.replaceRange(index, index + 1, ['Add Image']);
                                        });
...
class BackendService {
  static DVShopDropdownModel li1;
  ...
  static Future<List> getSuggestions(String query) async {
    ...
    url =
        ...
        String_values.base_url + 'shop-list?search=' + query;
    var response = await http.get(
      url,
      headers: {
        "Content-Type": "application/json",
    ...
    if (response.statusCode == 200) {
      ...
      li1 = DVShopDropdownModel.fromJson(json.decode(response.body));
      List<String> s = new List();
      if (li1.values.length == 0) {
        // return ["No details"];
      } else {
        for (int i = 0; i < li1.values.length; i++)
          s.add(li1.values[i].shopName.toString());
        print(s);
        return s;
      }
      // }
