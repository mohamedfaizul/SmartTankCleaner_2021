...
class GMView extends StatefulWidget {
  GMView({Key key, this.id});

  String id;

  @override
  GMViewState createState() => GMViewState();
}

class GMViewState extends State<GMView> {
...
class BackendService {
  ...
  static Future<List> getSuggestions(String query) async {
    var url;
    if (GMViewState.dropdownValue == "Vendor") {
      url =
    ...
    } else if (GMViewState.dropdownValue == "Supervisor") {
      url =
      //'http://35.184.156.126.xip.io/cyberhome/home.php?username=kavin&query=table';
