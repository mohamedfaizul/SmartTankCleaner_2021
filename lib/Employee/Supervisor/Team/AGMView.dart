...
import 'package:tankcare/Employee/EmployeeModels/Team/EmployeeView.dart';
...
class AGMView extends StatefulWidget {
  AGMView({Key key, this.id});

  String id;

  @override
  AGMViewState createState() => AGMViewState();
}

class AGMViewState extends State<AGMView> {
  ...
  TextEditingController offStateController = new TextEditingController();
  TextEditingController DistrictController = new TextEditingController();
  TextEditingController offDistrictController = new TextEditingController();
  ...
  TextEditingController ReportingToController = new TextEditingController();

  TextEditingController DateOfJoiningController = new TextEditingController();
  TextEditingController TotalPaidHolidayController = new TextEditingController();
  TextEditingController MonthlySalaryController = new TextEditingController();
  TextEditingController MaxTravelAllowanceController = new TextEditingController();
  TextEditingController MaxExpenseToController = new TextEditingController();
  ...
  TextEditingController EmployeeDOBController = new TextEditingController();
  TextEditingController EmployeeGenderController = new TextEditingController();
  ...
  TextEditingController offPincodeController = new TextEditingController();
  ...
  TextEditingController offaddressController = new TextEditingController();
  EmployeeView li;
  ...
  Future<http.Response> details(planid) async {
    ...
    var url = String_values.base_url + 'employee-view/' + planid;
    print(url);
    ...
    if (response.statusCode == 200) {
      li = EmployeeView.fromJson(json.decode(response.body));
      setState(() {
        if (li.values.longitude != null)
          longitudecamera = double.parse(li.values.longitude);
        if (li.values.latitude != null)
          latitudecamera = double.parse(li.values.latitude);
        _kGooglePlex = CameraPosition(
          // bearing: 192.8334901395799,
            target: LatLng(latitudecamera,
                longitudecamera),
            zoom: 14);
        NameController.text = li.values.empName.toString();
        EmployeeCodeController.text = li.values.empCode.toString();
        addressController.text = li.values.empAddress.toString();
        PincodeController.text = li.values.empPincode.toString();

        StateController.text = li.values.stateName.toString();
        DistrictController.text = li.values.districtName.toString();

        PhoneController.text = li.values.empPhone.toString();
        EmailController.text = li.values.empEmail.toString();
        MobileController.text = li.values.empPhoneAlter.toString();
        EmployeeDOBController.text =   DateFormat('dd/MM/yyyy').format(
            DateTime.parse(li.values.empDob.toString()));
        EmployeeGenderController.text = li.values.empGender.toString();
        li.values.empStatus.toString()=="A"?
        StatusController.text="Active"
            : StatusController.text="InActive";
        li45 = AccDetails.fromJson(
            json.decode(li.values.empBankDetails.toString()));

        ACCNameController.text = li45.empAccName.toString();
        ACCNoController.text = li45.empAccNo.toString();
        IFSCCodeController.text = li45.empAccIfsc.toString();
        BankNameController.text = li45.empAccBank.toString();
        BranchNameController.text = li45.empAccBranch.toString();

        offaddressController.text = li.values.empOfcAddress.toString();
        offPincodeController.text = li.values.empOfcPincode.toString();

        offStateController.text = li.values.ofcStateName.toString();
        offDistrictController.text = li.values.ofcDistrictName.toString();

        DesignationController.text = li.values.empDesignation.toString();
        EmploymentTypeController.text = li.values.empEmpType.toString();
        ReportingToController.text = li.values.reportingTo.toString();

        DateOfJoiningController.text =   DateFormat('dd/MM/yyyy').format(
            DateTime.parse(li.values.empDoj.toString()));
        TotalPaidHolidayController.text = li.values.totalPaidHoliday.toString();
        MonthlySalaryController.text = li.values.monthlySalary.toString();
        MaxTravelAllowanceController.text = li.values.maxTravelAllowance.toString();
        MaxExpenseToController.text = li.values.maxExpense.toString();
            ...
            children: <Widget>[
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            child: new TextField(
                              ...
                              minLines: 3,
                              maxLines: 15,
                              controller: offaddressController,
                              decoration: InputDecoration(
                                labelText: 'Address',
                                hintStyle: TextStyle(
                                  color: Colors.grey,
                        ...
                        Padding(
                          ...
                          child: Container(
                            child: new TextField(
                              enabled: false,
                              controller: offDistrictController,
                              decoration: InputDecoration(
                                labelText: 'District',
                                hintStyle: TextStyle(
                                  color: Colors.grey,
                        ...
                        Padding(
                          ...
                          child: Container(
                            child: new TextField(
                              enabled: false,
                              controller: offPincodeController,
                              maxLength: 6,
                              keyboardType: TextInputType.number,
                              decoration: InputDecoration(
                                labelText: 'Pincode',
              ...
              Container(
                  ...
                  child: ExpansionTile(
                      ...
                      children: [
                        li.values.empPhotos.toString() != "null"?Container(
                          child: Column(
                            children: [
                              GridView.count(
                                        ...
                                        child: Card(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                showDialog(
                                                    context: context,
                                                    child: Image.network(li.values.empPhotos[
                                                    index]
                                                        .imgPath));
                                              },
                                              child: Image.network(
                                                li.values.empPhotos[index]
                                                    .imgPath,
                                                height: 300,
                                                width: 300,
                                              ),
              ...
              Container(
                  ...
                  child: ExpansionTile(
                      ...
                      children: [
                        li.values.empProofs.toString() != "null"? Container(
                          child: Column(
                            children: [
                              GridView.count(
                                physics: ScrollPhysics(),
                                        ...
                                        child: Card(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                showDialog(
                                                    context: context,
                                                    child: Image.network(li.values.empProofs[
                                                    index]
                                                        .imgPath));
                                              },
                                              child: Image.network(
                                                li.values.empProofs[index]
                                                    .imgPath,
                                                height: 300,
                                                width: 300,
                                              ),
                  ...
                  child: ExpansionTile(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: new TextField(
                            enabled: false,
                            controller: TotalPaidHolidayController,
                            decoration: InputDecoration(
                              labelText: 'Total Paid Holiday',
                              hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 16.0,
                              ),
                  ...
                  child: ExpansionTile(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: new TextField(
                            enabled: false,
                            controller: MaxTravelAllowanceController,
                            decoration: InputDecoration(
                              labelText: 'Max Travel Allowance',
                              hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 16.0,
                              ),
                        ...
                        Padding(
                          ...
                          child: new TextField(
                            enabled: false,
                            controller: MaxExpenseToController,
                            decoration: InputDecoration(
                              labelText: 'Max Expense',
                              hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 16.0,
                              ),
...
class BackendService {
  ...
  static Future<List> getSuggestions(String query) async {
    var url;
    if (AGMViewState.dropdownValue == "Vendor") {
      url =
    ...
    } else if (AGMViewState.dropdownValue == "Supervisor") {
      url =
      //'http://35.184.156.126.xip.io/cyberhome/home.php?username=kavin&query=table';
