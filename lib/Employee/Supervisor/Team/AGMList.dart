...
class AGMList extends StatefulWidget {
  @override
  AGMListState createState() => AGMListState();
}

class AGMListState extends State<AGMList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'agm-list?search=${searchController.text}&page=${page}&limit=10';
          ...
          if (li3.list[i].title == "Team") {
            if (li3.list[i].children.toString() == "null") {
              ...
              for (int j = 0; j < li3.list[i].children.length; j++)
                if (li3.list[i].children[j].title == "Asst General Manager") {
