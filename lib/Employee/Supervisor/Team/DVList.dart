...
import 'package:tankcare/Employee/EmployeeModels/Team/DVList.dart';
...
import 'package:tankcare/Employee/Supervisor/Team/DVView.dart';
...
class DVList extends StatefulWidget {
  @override
  DVListState createState() => DVListState();
}

class DVListState extends State<DVList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'dvendor-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = DVListModel.fromJson(json.decode(response.body));
          ...
          if (li3.list[i].title == "Team") {
            if (li3.list[i].children.toString() == "null") {
              ...
              for (int j = 0; j < li3.list[i].children.length; j++)
                if (li3.list[i].children[j].title == "District Vendor") {
                    ...
                    DataCell(Center(
                        child: Center(
                          child: Wrap(
                              ...
                              alignment: WrapAlignment.center,
                              children: [
                                Text(list.dvendorName.toString(),
                                    textAlign: TextAlign.center)
                              ]),
                        ))),
                    DataCell(
                      Center(
                          child: Center(
                              child: Wrap(
                                  ...
                                  alignment: WrapAlignment.center,
                                  children: [
                                    Text(list.dvendorCompanyname.toString(),
                                        textAlign: TextAlign.center)
                                  ]))),
                    ),
                    DataCell(
                      Center(
                          child: Center(
                              child: Wrap(
                                  ...
                                  alignment: WrapAlignment.center,
                                  children: [
                                    Text(list.dvendorPhone.toString(),
                                        textAlign: TextAlign.center)
                                  ]))),
                    ),
                    DataCell(
                      Center(
                          child: Center(
                              child: Wrap(
                                  ...
                                  alignment: WrapAlignment.center,
                                  children: [
                                    Text(list.dvendorPassword.toString(),
                                        textAlign: TextAlign.center)
                                  ]))),
                    ),
                        DataCell(
