...
class FranchiseList extends StatefulWidget {
  @override
  FranchiseListState createState() => FranchiseListState();
}

class FranchiseListState extends State<FranchiseList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'team-franchise-list?search=${searchController.text}&page=${page}&limit=10';
    ...
    if (response.statusCode == 200) {
      ...
      li = FranchaiseList.fromJson(json.decode(response.body));
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        for (int i = 0; i < li3.list.length; i++) {
          if( (li3.list[i].title == "Team")|| (li3.list[i].title == "Franchise") ){
            if (li3.list[i].children.toString() == "null") {
              ...
              for (int j = 0; j < li3.list[i].children.length; j++)
                if (li3.list[i].children[j].title == "Franchise"||li3.list[i].children[j].title == "Franchise List") {
                            ...
                            (list) => DataRow(cells: [
                              ...
                              DataCell(Center(
                                ...
                                child: Wrap(
                                    ...
                                    alignment: WrapAlignment.center,
                                    children: [
                                      Text(list.franchisePhone.toString(),
                                          textAlign: TextAlign.center)
                                    ]),
                              ))),
                              DataCell(
