...
class RMView extends StatefulWidget {
  RMView({Key key, this.id});

  String id;

  @override
  RMViewState createState() => RMViewState();
}

class RMViewState extends State<RMView> {
...
class BackendService {
  ...
  static Future<List> getSuggestions(String query) async {
    var url;
    if (RMViewState.dropdownValue == "Vendor") {
      url =
    ...
    } else if (RMViewState.dropdownValue == "Supervisor") {
      url =
      //'http://35.184.156.126.xip.io/cyberhome/home.php?username=kavin&query=table';
