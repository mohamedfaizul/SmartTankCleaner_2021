...
import 'package:tankcare/Employee/EmployeeModels/Team/DVView.dart';
...
class DVView extends StatefulWidget {
  DVView({Key key, this.id});

  String id;

  @override
  DVViewState createState() => DVViewState();
}

class DVViewState extends State<DVView> {
  ...
  TextEditingController DvendorGSTController = new TextEditingController();
  TextEditingController DVendorCodeController = new TextEditingController();
  ...
  TextEditingController DVendorDOBController = new TextEditingController();
  TextEditingController DVendorGenderController = new TextEditingController();
  ...
  Future<http.Response> details(planid) async {
    ...
    var url = String_values.base_url + 'dvendor-view/' + planid;
    print(url);
    ...
    if (response.statusCode == 200) {
      li = DVViewModel.fromJson(json.decode(response.body));
      setState(() {
        ...
        _kGooglePlex = CameraPosition(
          // bearing: 192.8334901395799,
            target: LatLng(latitudecamera,
                longitudecamera),
            zoom: 14);
        NameController.text = li.items.dvendorName.toString();
        DVendorCodeController.text = li.items.dvendorCode.toString();
        addressController.text = li.items.dvendorAddress.toString();
        PincodeController.text = li.items.dvendorPincode.toString();

        StateController.text = li.items.stateName.toString();
        DistrictController.text = li.items.districtName.toString();

        PhoneController.text = li.items.dvendorPhone.toString();
        EmailController.text = li.items.dvendorEmail.toString();
        MobileController.text = li.items.dvendorPhoneAlter.toString();
        DVendorDOBController.text =   DateFormat('dd/MM/yyyy').format(
            DateTime.parse(li.items.dvendorDob.toString()));
        DVendorGenderController.text = li.items.dvendorGender.toString();
        li.items.dvendorStatus.toString()=="A"?
        StatusController.text="Active"
            : StatusController.text="InActive";
        li45 = AccDetails.fromJson(
            json.decode(li.items.dvendorBankDetails.toString()));

        ACCNameController.text = li45.dvendorAccName.toString();
        ACCNoController.text = li45.dvendorAccNo.toString();
        IFSCCodeController.text = li45.dvendorAccIfsc.toString();
        BankNameController.text = li45.dvendorAccBank.toString();
        BranchNameController.text = li45.dvendorAccBranch.toString();

        DvendorGSTController.text = li.items.dvendorGst.toString();
        CompanyController.text=li.items.dvendorCompanyname.toString();
        BranchNameController.text = li45.dvendorAccBranch.toString();
        DateOfJoiningController.text =   DateFormat('dd/MM/yyyy').format(
            DateTime.parse(li.items.dvendorDoj.toString()));
            ...
            children: <Widget>[
                  ...
                  child: ExpansionTile(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: new TextField(
                            enabled: false,
                            controller: DVendorCodeController,
                            decoration: InputDecoration(
                              labelText: 'DVendor Code',
                              hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 16.0,
                              ),
                        ...
                        Padding(
                          ...
                          child: new TextField(
                            enabled: false,
                            controller: DVendorDOBController,
                            decoration: InputDecoration(
                              labelText: 'DVendor DOB',
                              hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 16.0,
                              ),
                        ...
                        Padding(
                          ...
                          child: new TextField(
                            enabled: false,
                            controller: DVendorGenderController,
                            decoration: InputDecoration(
                              labelText: 'DVendor Gender',
                              hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 16.0,
                              ),
                        ...
                        Padding(
                          ...
                          child: new TextField(
                            enabled: false,
                            controller: DvendorGSTController,
                            decoration: InputDecoration(
                              labelText: 'DVendor GST',
                              hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 16.0,
                              ),
              ...
              Container(
                  ...
                  child: ExpansionTile(
                      ...
                      children: [
                        li.items.dvendorPhotos.toString() != "null"?Container(
                          child: Column(
                            children: [
                              GridView.count(
                                        ...
                                        child: Card(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                showDialog(
                                                    context: context,
                                                    child: Image.network(li.items.dvendorPhotos[
                                                    index]
                                                        .imgPath));
                                              },
                                              child: Image.network(
                                                li.items.dvendorPhotos[index]
                                                    .imgPath,
                                                height: 300,
                                                width: 300,
                                              ),
              ...
              Container(
                  ...
                  child: ExpansionTile(
                      ...
                      children: [
                        li.items.dvendorProofs.toString() != "null"? Container(
                          child: Column(
                            children: [
                              GridView.count(
                                physics: ScrollPhysics(),
                                        ...
                                        child: Card(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                showDialog(
                                                    context: context,
                                                    child: Image.network(li.items.dvendorProofs[
                                                    index]
                                                        .imgPath));
                                              },
                                              child: Image.network(
                                                li.items.dvendorProofs[index]
                                                    .imgPath,
                                                height: 300,
                                                width: 300,
                                              ),
...
class BackendService {
  ...
  static Future<List> getSuggestions(String query) async {
    var url;
    if (DVViewState.dropdownValue == "Vendor") {
      url =
    ...
    } else if (DVViewState.dropdownValue == "Supervisor") {
      url =
      //'http://35.184.156.126.xip.io/cyberhome/home.php?username=kavin&query=table';
