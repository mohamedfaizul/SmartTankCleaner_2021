...
class EmployeePropertyServiceList extends StatefulWidget {
  @override
  EmployeePropertyServiceListState createState() =>
      EmployeePropertyServiceListState();
}

class EmployeePropertyServiceListState
    extends State<EmployeePropertyServiceList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    var url = String_values.base_url +
        'property-plan-services?assign=n&page=${page}&limit=10&search=${searchController.text}&assign_status=${dropdownValue.toUpperCase()}&verify_status=${dropdownValue2.toUpperCase()}&start_date=$sql_dob_from';
    print(url);
    ...
    if (response.statusCode == 200) {
      ...
      li = ServiceListings.fromJson(json.decode(response.body));
                            ...
                            (list) => DataRow(cells: [
                              ...
                              DataCell(Center(
                                ...
                                child: Wrap(
                                    ...
                                    alignment: WrapAlignment.center,
                                    children: [
                                      Text(list.propertyName.toString(),
                                          textAlign: TextAlign.center)
                                    ]),
                              ))),
                              DataCell(
                                Center(
                                    child: Center(
                                      ...
                                      Text(  DateFormat('dd/MM/yyyy').format(
                                            DateTime.parse(list.pplanStartDate.toString())),
                                          textAlign: TextAlign.center)
                                    ]))),
                              ),
                              DataCell(
