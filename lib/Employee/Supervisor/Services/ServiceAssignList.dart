...
import '../../../Vendor/Services/VendorServiceDetail.dart';
import '../../../string_values.dart';
import 'ServiceAssign.dart';



class ServiceAssignList extends StatefulWidget {
  @override
  ServiceAssignListState createState() => ServiceAssignListState();
}

class ServiceAssignListState extends State<ServiceAssignList> {
  bool loading = false;
  ...
  Future<http.Response> postRequest() async {
    ...
    if (dropdownValue == '-- Approval Status --')
      ...
      stat = dropdownValue.toString().toUpperCase();

    url = String_values.base_url +
        'property-plan-services?assign=n&page=${page}&limit=10&sType=$stype&status=$stat&mobile_no=${searchController.text}&&from_date=${sql_dob_from}&to_date=${sql_dob_to}';
    print(url);
