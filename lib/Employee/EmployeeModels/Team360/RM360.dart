class RM360Model {
  ...
  RM360Model({this.status, this.data});

  RM360Model.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    rm = json['rm'] != null ? new Rm.fromJson(json['rm']) : null;
...
class Rm {
  ...
  Rm({this.uid, this.ucode, this.uname, this.uphone, this.uroleid});
