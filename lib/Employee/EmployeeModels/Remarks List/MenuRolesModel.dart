class EmployeeLRemarksMenuRolesModel {
  bool status;
  List<Values> values;

  EmployeeLRemarksMenuRolesModel({this.status, this.values});

  EmployeeLRemarksMenuRolesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['values'] != null) {
