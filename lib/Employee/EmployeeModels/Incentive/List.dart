class EmployeeIncentiveListModel {
  bool status;
  int totalCount;
  List<Items> items;

  EmployeeIncentiveListModel({this.status, this.totalCount, this.items});

  EmployeeIncentiveListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
